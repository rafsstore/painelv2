...
exit;
  ...
  echo -e 'by: @Rafael_Djaay' >/usr/lib/telegram
  msg -bar
...
wget https://raw.githubusercontent.com/rafsstore/painelv2/main/pweb > /dev/null 2>&1
chmod 777 pweb > /dev/null 2>&1
clear
[[ ! -d /bin/ppweb ]] && mkdir /bin/ppweb
cd /bin/ppweb || exit
rm *.sh ver* > /dev/null 2>&1
wget https://raw.githubusercontent.com/rafsstore/painelv2/main/verifatt.sh > /dev/null 2>&1
wget https://raw.githubusercontent.com/rafsstore/painelv2/main/verpweb > /dev/null 2>&1
wget https://raw.githubusercontent.com/rafsstore/painelv2/main/verweb > /dev/null 2>&1
wget https://raw.githubusercontent.com/rafsstore/painelv2/main/whatsapp.sh > /dev/null 2>&1
...
wget https://raw.githubusercontent.com/rafsstore/painelv2/main/rafsssh.zip > /dev/null 2>&1
...
function inst_db { 
sed -i "s;dominio;$IP;g" /var/www/html/rafsssh.sql > /dev/null 2>&1
sleep 1
if [[ -e "/var/www/html/rafsssh.sql" ]]; then
    mysql -h localhost -u root -p"$pwdroot" --default_character_set utf8 sshplus < /var/www/html/rafsssh.sql > /dev/null 2>&1
    rm /var/www/html/rafsssh.sql > /dev/null 2>&1
else
    clear
...
echo ""
echo -e "RAFS PWEB V2" | figlet | boxes -d stone -p a0v0 | lolcat
echo -e "                              \033[1;31mBy @Rafael_Djaay\033[1;36m" | lolcat
echo ""
chave=$(curl -sSL "https://raw.githubusercontent.com/rafsstore/painelv2/main/chave") &>/dev/null
...
echo -e "\033[1;33m MAIS INFORMAÇÕES \033[1;31m(\033[1;36mTELEGRAM\033[1;31m): \033[1;37m@Rafael_Djaay\033[0m" | lolcat
echo ""
