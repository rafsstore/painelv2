...
wget https://raw.githubusercontent.com/rafsstore/painelv2/main/install/pweb > /dev/null 2>&1
chmod 777 pweb > /dev/null 2>&1
clear
[[ ! -d /bin/ppweb ]] && mkdir /bin/ppweb
cd /bin/ppweb || exit
rm *.sh ver* > /dev/null 2>&1
wget https://raw.githubusercontent.com/rafsstore/painelv2/main/install/verifatt.sh > /dev/null 2>&1
wget https://raw.githubusercontent.com/rafsstore/painelv2/main/install/verpweb > /dev/null 2>&1
wget https://raw.githubusercontent.com/rafsstore/painelv2/main/install/verweb > /dev/null 2>&1
...
wget https://raw.githubusercontent.com/rafsstore/painelv2/main/install/rafsssh.zip > /dev/null 2>&1
